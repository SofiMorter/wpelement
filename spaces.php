...
<div class="page-content-wrapper">
  <section class="spaces-first">
    ...
    <ul>
      <li><a href="http://element1/spaces/gostinaya/">Гостиная</a></li>
      <li><a href="http://element1/spaces/bedroom/">Спальня</a></li>
      <li><a href="http://element1/spaces/detskaya/">Детская</a></li>
      <li><a href="http://element1/spaces/vannaya/">Ванная комната</a></li>
      <li><a href="http://element1/spaces/kuhnya/">Кухня</a></li>
      <li><a href="http://element1/spaces/garazh/">Гараж</a></li>
      <li><a href="http://element1/spaces/ofis/">Офис</a></li>
      <li><a href="http://element1/spaces/kommercheskie-pomeshheniya/">Коммерческие помещения</a></li>
      <li><a href="http://element1/spaces/fasady/">Для наружных работ</a></li>
    </ul>
  </section>
  <section class="space-grid">
    <div class="space-grid_row">
      ...
      <div class="space-grid_row-triple">
        <div class="space-grid_row-triple_big">
          <a href="http://element1/spaces/bedroom/" class="space-grid_a">
        ...
        <div class="space-grid_row-triple_smol">
          <a href="http://element1/spaces/detskaya/" class="space-grid_a">
            <div class="box-img" style="background-image: url(<?php echo get_field('spaces_img3')['url']; ?>);">
              <span>Детская комната</span></div>
          </a>
        </div>
        <div class="space-grid_row-triple_smol">
          <a href="http://element1/spaces/vannaya/" class="space-grid_a">
    ...
    <div class="space-grid_row">
      <a href="http://element1/spaces/kuhnya" class="space-grid_a">
    ...
    <div class="space-grid_row">
      ...
      <div class="space-grid_row-triple">
        <div class="space-grid_row-triple_big">
          <a href="http://element1/spaces/garazh/" class="space-grid_a">
            <div class="box-img" style="background-image: url(<?php echo get_field('spaces_img6')['url']; ?>);">
              <span>Гараж</span></div>
          </a>
        </div>
        <div class="space-grid_row-triple_smol">
          <a href="http://element1/spaces/ofis/" class="space-grid_a">
            <div class="box-img" style="background-image: url(<?php echo get_field('spaces_img7')['url']; ?>);">
              <span>Офис</span></div>
          </a>
        </div>
        <div class="space-grid_row-triple_smol">
          <a href="http://element1/spaces/kommercheskie-pomeshheniya/" class="space-grid_a">
      ...
      <div class="space-grid_row-big">
        <a href="http://element1/spaces/fasady/" class="space-grid_a">
