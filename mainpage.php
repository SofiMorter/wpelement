    ...
    <section class="sec-hat">
        <div class="block">
            ...
            <div class="block-content">
                ...
                <p>
                    В нашем салоне представлена коллекция декоративных покрытий от итальянского производителя San Marco,
                    а также другие необходимые для
                    шикарного интерьера материалы от известных мировых брендов.
                </p>
                <p>
                    Мы сотрудничаем с дизайн-студиями и индивидуальными дизайнерами, чтобы помочь вам сделать правильный
                    выбор при оформлении жилых и
                    нежилых пространств.
                </p>
            </div>
        </div>
